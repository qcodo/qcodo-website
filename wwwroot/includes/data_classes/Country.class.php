<?php
	...
	class Country extends CountryGen {
		...
		public function __toString() {
			return sprintf('Country Object %s',  $this->intId);
		}
...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return an array of Country objects
			return Country::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::Country()->Param1, $strParam1),
					QQ::GreaterThan(QQN::Country()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single Country object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of Country objects
			return Country::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::Country()->Param1, $strParam1),
					QQ::Equal(QQN::Country()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
