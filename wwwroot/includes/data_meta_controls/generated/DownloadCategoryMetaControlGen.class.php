<?php
	 ...
	 * property-read DownloadCategory $DownloadCategory the actual DownloadCategory data class being edited
	...
	class DownloadCategoryMetaControlGen extends QBaseClass {
		// General Variables
