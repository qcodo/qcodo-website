<?php
	 ...
	 * property-read Announcement $Announcement the actual Announcement data class being edited
	 * property QLabel $IdControl
	 * property-read QLabel $IdLabel
	 * property QTextBox $AnnouncementControl
	 * property-read QLabel $AnnouncementLabel
	 * property-read string $TitleVerb a verb indicating whether or not this is being edited or created
	 * property-read boolean $EditMode a boolean indicating whether or not this is being edited or created
	 */

	class AnnouncementMetaControlGen extends QBaseClass {
		// General Variables
