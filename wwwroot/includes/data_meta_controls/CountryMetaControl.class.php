<?php
	...
	class CountryMetaControl extends QBaseClass {
		// General Variables
		...
		public function txtCode_Create($strControlId = null) {
			...
			$this->txtCode->Text = $this->objCountry->Code;
			$this->txtCode->MaxLength = Country::CodeMaxLength;
			return $this->txtCode;
		}
		...
		public function lblCode_Create($strControlId = null) {
			...
			$this->lblCode->Text = $this->objCountry->Code;
			return $this->lblCode;
		}
		...
		public function Refresh($blnReload = false) {
			...
			if ($this->txtCode) $this->txtCode->Text = $this->objCountry->Code;
			if ($this->lblCode) $this->lblCode->Text = $this->objCountry->Code;
		...
		public function SaveCountry() {
			try {
				...
				if ($this->txtCode) $this->objCountry->Code = $this->txtCode->Text;
