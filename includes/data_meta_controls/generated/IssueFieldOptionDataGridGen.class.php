<?php
	 ...
	 * listing a collection of IssueFieldOption objects.  It includes
	 ...
	 * 
	 */
	class IssueFieldOptionDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this IssueFieldOption datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the IssueFieldOption object, or it can be any QQNode extending from QQN::IssueFieldOption().
		 * 
		 ...
		 * sorting using two fields from the IssueFieldOption object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from IssueFieldOption
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = IssueFieldOption::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a IssueFieldOption-based QQNode.
		 * It will also verify that it is a proper IssueFieldOption-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'issue_field_option') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "issue_field_option".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::IssueFieldOption()->Id;
				case 'IssueFieldId': return QQN::IssueFieldOption()->IssueFieldId;
				case 'IssueField': return QQN::IssueFieldOption()->IssueField;
				case 'Name': return QQN::IssueFieldOption()->Name;
				case 'Token': return QQN::IssueFieldOption()->Token;
				case 'OrderNumber': return QQN::IssueFieldOption()->OrderNumber;
				case 'ActiveFlag': return QQN::IssueFieldOption()->ActiveFlag;
				default: throw new QCallerException('Simple Property not found in IssueFieldOptionDataGrid content: ' . $mixContent);
