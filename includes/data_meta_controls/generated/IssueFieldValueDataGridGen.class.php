<?php
	 ...
	 * listing a collection of IssueFieldValue objects.  It includes
	 ...
	 * 
	 */
	class IssueFieldValueDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this IssueFieldValue datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the IssueFieldValue object, or it can be any QQNode extending from QQN::IssueFieldValue().
		 * 
		 ...
		 * sorting using two fields from the IssueFieldValue object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from IssueFieldValue
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = IssueFieldValue::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from IssueFieldValue, given the clauses above
			$this->DataSource = IssueFieldValue::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a IssueFieldValue-based QQNode.
		 * It will also verify that it is a proper IssueFieldValue-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'issue_field_value') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "issue_field_value".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::IssueFieldValue()->Id;
				case 'IssueId': return QQN::IssueFieldValue()->IssueId;
				case 'Issue': return QQN::IssueFieldValue()->Issue;
				case 'IssueFieldId': return QQN::IssueFieldValue()->IssueFieldId;
				case 'IssueField': return QQN::IssueFieldValue()->IssueField;
				case 'IssueFieldOptionId': return QQN::IssueFieldValue()->IssueFieldOptionId;
				case 'IssueFieldOption': return QQN::IssueFieldValue()->IssueFieldOption;
				default: throw new QCallerException('Simple Property not found in IssueFieldValueDataGrid content: ' . $mixContent);
