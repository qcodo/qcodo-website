<?php
	 ...
	 * listing a collection of IssueVote objects.  It includes
	 ...
	 * 
	 */
	class IssueVoteDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this IssueVote datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the IssueVote object, or it can be any QQNode extending from QQN::IssueVote().
		 * 
		 ...
		 * sorting using two fields from the IssueVote object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from IssueVote
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = IssueVote::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from IssueVote, given the clauses above
			$this->DataSource = IssueVote::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a IssueVote-based QQNode.
		 * It will also verify that it is a proper IssueVote-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'issue_vote') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "issue_vote".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::IssueVote()->Id;
				case 'IssueId': return QQN::IssueVote()->IssueId;
				case 'Issue': return QQN::IssueVote()->Issue;
				case 'PersonId': return QQN::IssueVote()->PersonId;
				case 'Person': return QQN::IssueVote()->Person;
				case 'VoteDate': return QQN::IssueVote()->VoteDate;
				default: throw new QCallerException('Simple Property not found in IssueVoteDataGrid content: ' . $mixContent);
