<?php
	 ...
	 * listing a collection of Forum objects.  It includes
	 ...
	 * 
	 */
	class ForumDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Forum datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Forum object, or it can be any QQNode extending from QQN::Forum().
		 * 
		 ...
		 * sorting using two fields from the Forum object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Forum
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Forum::QueryCount($objCondition, $objClauses);
			...
			$this->DataSource = Forum::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Forum-based QQNode.
		 * It will also verify that it is a proper Forum-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'forum') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "forum".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::Forum()->Id;
				case 'OrderNumber': return QQN::Forum()->OrderNumber;
				case 'Name': return QQN::Forum()->Name;
				case 'AnnounceOnlyFlag': return QQN::Forum()->AnnounceOnlyFlag;
				case 'Description': return QQN::Forum()->Description;
				case 'TopicLink': return QQN::Forum()->TopicLink;
