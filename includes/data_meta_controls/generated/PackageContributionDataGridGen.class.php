<?php
	 ...
	 * listing a collection of PackageContribution objects.  It includes
	 ...
	 * 
	 */
	class PackageContributionDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this PackageContribution datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the PackageContribution object, or it can be any QQNode extending from QQN::PackageContribution().
		 * 
		 ...
		 * sorting using two fields from the PackageContribution object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from PackageContribution
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = PackageContribution::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a PackageContribution-based QQNode.
		 * It will also verify that it is a proper PackageContribution-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'package_contribution') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "package_contribution".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::PackageContribution()->Id;
				case 'PackageId': return QQN::PackageContribution()->PackageId;
				case 'Package': return QQN::PackageContribution()->Package;
				case 'PersonId': return QQN::PackageContribution()->PersonId;
				case 'Person': return QQN::PackageContribution()->Person;
				case 'CurrentPackageVersionId': return QQN::PackageContribution()->CurrentPackageVersionId;
				case 'CurrentPackageVersion': return QQN::PackageContribution()->CurrentPackageVersion;
				case 'CurrentPostDate': return QQN::PackageContribution()->CurrentPostDate;
				case 'DownloadCount': return QQN::PackageContribution()->DownloadCount;
				default: throw new QCallerException('Simple Property not found in PackageContributionDataGrid content: ' . $mixContent);
