<?php
	 ...
	 * listing a collection of EmailQueue objects.  It includes
	 ...
	 * 
	 */
	class EmailQueueDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this EmailQueue datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the EmailQueue object, or it can be any QQNode extending from QQN::EmailQueue().
		 * 
		 ...
		 * sorting using two fields from the EmailQueue object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from EmailQueue
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = EmailQueue::QueryCount($objCondition, $objClauses);
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::EmailQueue()->Id;
				case 'ToAddress': return QQN::EmailQueue()->ToAddress;
				case 'FromAddress': return QQN::EmailQueue()->FromAddress;
