<?php
	 ...
	 * listing a collection of Issue objects.  It includes
	 ...
	 * 
	 */
	class IssueDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Issue datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Issue object, or it can be any QQNode extending from QQN::Issue().
		 * 
		 ...
		 * sorting using two fields from the Issue object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Issue
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Issue::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Issue, given the clauses above
			$this->DataSource = Issue::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Issue-based QQNode.
		 * It will also verify that it is a proper Issue-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'issue') {
				...
				case 'ExampleData': return QQN::Issue()->ExampleData;
				case 'ExpectedOutput': return QQN::Issue()->ExpectedOutput;
				case 'ActualOutput': return QQN::Issue()->ActualOutput;
				case 'PostedByPersonId': return QQN::Issue()->PostedByPersonId;
				case 'PostedByPerson': return QQN::Issue()->PostedByPerson;
				case 'AssignedToPersonId': return QQN::Issue()->AssignedToPersonId;
				case 'AssignedToPerson': return QQN::Issue()->AssignedToPerson;
				case 'PostDate': return QQN::Issue()->PostDate;
