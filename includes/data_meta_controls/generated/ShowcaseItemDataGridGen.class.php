<?php
	 ...
	 * listing a collection of ShowcaseItem objects.  It includes
	 ...
	 * 
	 */
	class ShowcaseItemDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ShowcaseItem datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ShowcaseItem object, or it can be any QQNode extending from QQN::ShowcaseItem().
		 * 
		 ...
		 * sorting using two fields from the ShowcaseItem object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ShowcaseItem
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ShowcaseItem::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ShowcaseItem-based QQNode.
		 * It will also verify that it is a proper ShowcaseItem-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'showcase_item') {
				...
				case 'Description': return QQN::ShowcaseItem()->Description;
				case 'Url': return QQN::ShowcaseItem()->Url;
				case 'LiveFlag': return QQN::ShowcaseItem()->LiveFlag;
				default: throw new QCallerException('Simple Property not found in ShowcaseItemDataGrid content: ' . $mixContent);
