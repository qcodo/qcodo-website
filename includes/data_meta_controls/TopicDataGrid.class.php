<?php
	require(__DATAGEN_META_CONTROLS__ . '/TopicDataGridGen.class.php');

	/**
	 * This is the "Meta" DataGrid customizable subclass for the List functionality
	 * of the Topic class.  This code-generated class extends
	 * from the generated Meta DataGrid class which contains a QDataGrid class which
	 * can be used by any QForm or QPanel, listing a collection of Topic
	 ...
	 * 
	 */
	class TopicDataGrid extends TopicDataGridGen {
	}
?>