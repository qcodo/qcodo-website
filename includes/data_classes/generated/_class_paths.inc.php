<?php 
	// ClassPaths for the Counter class
		...
		QApplicationBase::$ClassFile['qqreversereferencenodecounter'] = __DATA_CLASSES__ . '/Counter.class.php';
		QApplicationBase::$ClassFile['countermetacontrol'] = __DATA_META_CONTROLS__ . '/CounterMetaControl.class.php';
		QApplicationBase::$ClassFile['counterdatagrid'] = __DATA_META_CONTROLS__ . '/CounterDataGrid.class.php';
	...
	// ClassPaths for the Forum class
		QApplicationBase::$ClassFile['forum'] = __DATA_CLASSES__ . '/Forum.class.php';
		QApplicationBase::$ClassFile['qqnodeforum'] = __DATA_CLASSES__ . '/Forum.class.php';
		QApplicationBase::$ClassFile['qqreversereferencenodeforum'] = __DATA_CLASSES__ . '/Forum.class.php';
	...
	// ClassPaths for the LoginTicket class
		...
		QApplicationBase::$ClassFile['qqreversereferencenodeloginticket'] = __DATA_CLASSES__ . '/LoginTicket.class.php';
		QApplicationBase::$ClassFile['loginticketmetacontrol'] = __DATA_META_CONTROLS__ . '/LoginTicketMetaControl.class.php';
		QApplicationBase::$ClassFile['loginticketdatagrid'] = __DATA_META_CONTROLS__ . '/LoginTicketDataGrid.class.php';

	// ClassPaths for the Message class
		QApplicationBase::$ClassFile['message'] = __DATA_CLASSES__ . '/Message.class.php';
		QApplicationBase::$ClassFile['qqnodemessage'] = __DATA_CLASSES__ . '/Message.class.php';
		QApplicationBase::$ClassFile['qqreversereferencenodemessage'] = __DATA_CLASSES__ . '/Message.class.php';
