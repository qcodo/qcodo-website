	...
	<?php $_CONTROL->txtMessage->RenderForDialog('CssClass=forumMessage','Instructions=To apply formatting, use <a href="/wiki/qcodo/qtextstyle">QTextStyle Formatting</a>.'); ?>
